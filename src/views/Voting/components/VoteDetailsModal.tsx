...
import { Box, Flex, InjectedModalProps, Modal, Button, Spinner } from '@dragonchaindex/toolkit'
...
const VoteDetailsModal: React.FC<VoteDetailsModalProps> = ({ block, onDismiss }) => {
  ...
  return (
    <Modal title={t('Voting Power')} onDismiss={handleDismiss} headerBackground="red">
