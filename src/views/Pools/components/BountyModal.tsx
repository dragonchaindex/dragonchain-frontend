...
import { Modal, Text, Flex, Button, HelpIcon, AutoRenewIcon, useTooltip } from '@dragonchaindex/toolkit'
...
const BountyModal: React.FC<BountyModalProps> = ({ onDismiss, TooltipComponent }) => {
  ...
  return (
    <Modal title={t('Claim Bounty')} onDismiss={onDismiss} headerBackground="red">
