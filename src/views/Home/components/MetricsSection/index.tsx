...
import { Heading, Flex, Text, Skeleton, ChartIcon, CommunityIcon, SwapIcon } from '@dragonchaindex/toolkit'
  ...
  return (
    <Flex justifyContent="center" alignItems="center" flexDirection="column">
      ...
      <Text textAlign="center" color="textSubtle">
        {t('DragonChain has the most users of any decentralized platform, ever.')}
      </Text>
      <Flex flexWrap="wrap">
