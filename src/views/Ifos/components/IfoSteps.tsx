...
import { Stepper, Step, StepStatus, Card, CardBody, Heading, Text, Button, Link, OpenNewIcon } from '@dragonchaindex/toolkit'
        ...
        return (
          <CardBody>
            ...
            <Text color="textSubtle" small mb="16px">
              {t('You’ll need an active DragonChain Profile to take part in an IFO!')}
            </Text>
            {isStepValid ? (
