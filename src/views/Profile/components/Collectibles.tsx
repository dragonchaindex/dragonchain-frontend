...
import { Heading, Text, Flex, ChevronRightIcon } from '@dragonchaindex/toolkit'
...
const Collectibles = () => {
  ...
  return (
    <>
      ...
      <Text as="p">
        {t('Pancake Collectibles are special ERC-721 NFTs that can be used on the DragonChain platform.')}
      </Text>
      <Text as="p">
