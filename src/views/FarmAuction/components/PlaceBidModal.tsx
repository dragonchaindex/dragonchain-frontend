...
import { Modal, Text, Flex, BalanceInput, Box, Button, PancakeRoundIcon } from '@dragonchaindex/toolkit'
...
const PlaceBidModal: React.FC<PlaceBidModalProps> = ({
  ...
  useEffect(() => {
    if (userNotEnoughCake) {
      setErrorText(t('Insufficient DRAC balance'))
  ...
  return (
    <StyledModal title={t('Place a Bid')} onDismiss={onDismiss} headerBackground="black">
      <ExistingInfo>
