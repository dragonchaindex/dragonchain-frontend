...
import { Flex, Text, Heading, Image } from '@dragonchaindex/toolkit'
...
const BattleBanner = () => {
  ...
  return (
    <Flex flexDirection="column">
      ...
      <StyledHeading2Text background="red" $fill>
        {t('$200,000 in Prizes!')}
      </StyledHeading2Text>
      <StyledHeading scale="md" color={true ? 'textSubtle' : 'inputSecondary'} mt="16px">
