...
export const DEFAULT_META: PageMeta = {
  title: 'DragonChain',
  description:
    'Aiming to be the largest and most secure DEX platform on the Binance Smart Chain (BSC), Dragonchain helps investors earn safe and reliable yields.',
  image: 'https://dragonchain.finance/images/hero.png',
}
