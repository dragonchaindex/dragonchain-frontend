...
import { AutoRenewIcon, Button, Checkbox, Flex, InjectedModalProps, Text } from '@dragonchaindex/toolkit'
...
const PauseProfilePage: React.FC<PauseProfilePageProps> = ({ onDismiss }) => {
  ...
  return (
    <>
      ...
      <Text as="p" color="textSubtle" mb="24px">
        {t('Cost to reactivate in the future: %cost% DRAC', { cost: formatBigNumber(numberCakeToReactivate) })}
      </Text>
